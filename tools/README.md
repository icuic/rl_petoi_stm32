...
- `rl_serial_protocol_v0.py`：RL 串口协议的 host-side reference codec，可生成测试向量、自检 binary frame，并做真机串口 smoke probe。
...
.venv/bin/python tools/rl_serial_protocol_v0.py --port /dev/ttyUSB0 --get-state
```
